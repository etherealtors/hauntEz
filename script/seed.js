...
async function seed() {
  ...
  const users = await Promise.all([
    User.create({
      ...
      role: 'buyer',
      image:
        'https://amp.thisisinsider.com/images/5bd3280a8b03df232c6a9592-750-562.jpg'
    }),
    User.create({
      name: 'Hank Horrible',
    ...
    User.create({
      ...
      isAdmin: true,
      image:
        'https://upload.wikimedia.org/wikipedia/en/thumb/e/ec/Piratedavyjones.JPG/220px-Piratedavyjones.JPG'
    }),
    User.create({
  ...
  const reviews = await Promise.all([
    ...
    Review.create({
      content:
        'Rotten menacing fatal bleak, monstrosity dread with demon scourge terrifying.',
      rating: 5,
      userId: 3,
      locationId: 2
    }),
    ...
    Review.create({
      content:
        'Trapped daring rotten worms, vampire monstrosity bleak are at flesh. Needles at bowels alarming.',
      rating: 5,
      userId: 1,
      locationId: 4
    }),
    ...
    Review.create({
      content:
        'Occult at alley pushed. Haunt tearing murder crying an mental corpse zombies evil,',
      rating: 3,
      userId: 4,
      locationId: 6
    }),
    ...
    Review.create({
      content:
        'Zombie in virus scared cat Michael Myers worms. Cat at decapitated guns.',
      rating: 3,
      userId: 7,
      locationId: 7
    }),
    Review.create({
      content:
        'Breathing heavily damp, cold and crying running, stalking slicing stabbing dripping (blood)',
      rating: 1,
      userId: 1,
      locationId: 8
    }),
    ...
    Review.create({
      content:
        'Falling are graveyard graves est. Tearing eyeballs zombie slash.',
      rating: 2,
      userId: 4,
      locationId: 9
    }),
    ...
    Review.create({
      content:
        ' Killer scourge scared, drowning helpless sheep at, terrifying and crazy gory.',
      rating: 5,
      userId: 6,
      locationId: 10
    }),
